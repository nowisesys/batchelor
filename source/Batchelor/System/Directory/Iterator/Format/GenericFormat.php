...
/**
 * Format directory iterator.
 *
 * @author Anders Lövgren (Nowise Systems)
 */
class GenericFormat implements IteratorAggregate
{
        ...
        /**
         * Constructor.
         * @param DirectoryIterator $iterator The directory iterator.
         */
        public function __construct($iterator)
        {
                $this->_iterator = $iterator;
                $this->_formatter = function($fileinfo) {
