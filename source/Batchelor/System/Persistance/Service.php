 ...
 * 
 * Provides persistance using cookie or session storage. The default storage is
 * cookies. Consider also to use the cache service when suitable.
 *
 * @author Anders Lövgren (Nowise Systems)
 */
class Service implements StorageService
{
